...
<p align="center">
  <img src="images/plaid_benchmarks.png" alt="PLAID Benchmarks" width="600">
</p>
...
| Dataset | Dataset links | Benchmark |
| --- | --- | --- |
| **Tensile2d** | [![Zenodo](https://zenodo.org/badge/DOI/10.5281/zenodo.14840177.svg)](https://doi.org/10.5281/zenodo.14840177) [![Hugging Face](https://huggingface.co/datasets/huggingface/badges/resolve/main/dataset-on-hf-md-dark.svg)](https://huggingface.co/datasets/PLAID-datasets/Tensile2d) | [![Benchmark](https://huggingface.co/datasets/huggingface/badges/resolve/main/open-in-hf-spaces-sm-dark.svg)](https://huggingface.co/spaces/PLAIDcompetitions/Tensile2dBenchmark) |
| **2D_MultiScHypEl** | [![Zenodo](https://zenodo.org/badge/DOI/10.5281/zenodo.14840446.svg)](https://doi.org/10.5281/zenodo.14840446) [![Hugging Face](https://huggingface.co/datasets/huggingface/badges/resolve/main/dataset-on-hf-md-dark.svg)](https://huggingface.co/datasets/PLAID-datasets/2D_Multiscale_Hyperelasticity) | [![Benchmark](https://huggingface.co/datasets/huggingface/badges/resolve/main/open-in-hf-spaces-sm-dark.svg)](https://huggingface.co/spaces/PLAIDcompetitions/2DMultiscaleHyperelasticityBenchmark) |
| **2D_ElPlDynamics** | [![Zenodo](https://zenodo.org/badge/DOI/10.5281/zenodo.15286369.svg)](https://doi.org/10.5281/zenodo.15286369) [![Hugging Face](https://huggingface.co/datasets/huggingface/badges/resolve/main/dataset-on-hf-md-dark.svg)](https://huggingface.co/datasets/PLAID-datasets/2D_ElastoPlastoDynamics) | [![Benchmark](https://huggingface.co/datasets/huggingface/badges/resolve/main/open-in-hf-spaces-sm-dark.svg)](https://huggingface.co/spaces/PLAIDcompetitions/2DElastoPlastoDynamics) |
| **Rotor37** | [![Zenodo](https://zenodo.org/badge/DOI/10.5281/zenodo.14840190.svg)](https://doi.org/10.5281/zenodo.14840190) [![Hugging Face](https://huggingface.co/datasets/huggingface/badges/resolve/main/dataset-on-hf-md-dark.svg)](https://huggingface.co/datasets/PLAID-datasets/Rotor37) | [![Benchmark](https://huggingface.co/datasets/huggingface/badges/resolve/main/open-in-hf-spaces-sm-dark.svg)](https://huggingface.co/spaces/PLAIDcompetitions/Rotor37Benchmark) |
...
| --- | --- |
| **AirfRANS original** | [![Zenodo](https://zenodo.org/badge/DOI/10.5281/zenodo.14840387.svg)](https://doi.org/10.5281/zenodo.14840387) [![Hugging Face](https://huggingface.co/datasets/huggingface/badges/resolve/main/dataset-on-hf-md-dark.svg)](https://huggingface.co/datasets/PLAID-datasets/AirfRANS_original) |
| **AirfRANS clipped** | [![Zenodo](https://zenodo.org/badge/DOI/10.5281/zenodo.14840377.svg)](https://doi.org/10.5281/zenodo.14840377) [![Hugging Face](https://huggingface.co/datasets/huggingface/badges/resolve/main/dataset-on-hf-md-dark.svg)](https://huggingface.co/datasets/PLAID-datasets/AirfRANS_clipped) |
| **AirfRANS remeshed** | [![Zenodo](https://zenodo.org/badge/DOI/10.5281/zenodo.14840388.svg)](https://doi.org/10.5281/zenodo.14840388) [![Hugging Face](https://huggingface.co/datasets/huggingface/badges/resolve/main/dataset-on-hf-md-dark.svg)](https://huggingface.co/datasets/PLAID-datasets/AirfRANS_remeshed) |
