...
- (types) integrate beartype runtime type checking and improve type annotations across the package, including structural protocols for service dependencies and runtime-safe NumPy array aliases.
