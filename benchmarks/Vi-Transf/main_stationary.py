...
def main(cfg):
    ...
    plaid_train_dataset, plaid_val_dataset = split_plaid_train_test(plaid_train_dataset, train_ids=train_ids, test_ids=val_ids)
    train_dataset, val_dataset = split_pyg_train_test(train_dataset, train_ids=train_ids, test_ids=val_ids)
    ...
    test_dataset = model.preprocess(pyg_dataset=test_dataset,
    ...
    post_processed_dataset = model.postprocess(prediction_dataset, plaid_test_dataset, type="test")
    prediction_dataset_unscaled = scaler.inverse_transform_prediction(post_processed_dataset)
