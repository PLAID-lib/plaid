...
#        assert list(dataset._samples.keys()) == [10]
    ...
    #     assert sorted(dataset_with_samples.get_field_names()) == sorted(
    #         ["test_field_2785", "test_field_same_size"]
    #     )
    #     assert sorted(
    ...
    #     ) == sorted(["test_field_2785", "test_field_same_size"])
    #     assert sorted(
    #         dataset_with_samples.get_field_names(base_name="Base_Name")
    #     ) == sorted(["test_field_2785", "test_field_same_size"])
    #     assert sorted(dataset_with_samples.get_field_names(time=0.0)) == sorted(
    #         ["test_field_2785", "test_field_same_size"]
    #     )
    ...
    #     dataset_with_samples_with_tree.update_features_by_path(
    #         feature_identifiers=FeatureIdentifier(
    #             {
    #                 "type": "field",
    #                 "name": "test_node_field_1",
    ...
    #     dataset.get_backend().add_sample(samples)
    # def test_add_sample_fail_type(self, dataset):
    #     with pytest.raises(TypeError):
    #         dataset.get_backend().add_sample(1)
